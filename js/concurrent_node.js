...
app.registerExtension({
        name: "Shaobkj.VIP.ConcurrentImageEdit",
	async beforeRegisterNodeDef(nodeType, nodeData, app) {
		if (nodeData.name === "Shaobkj_ConcurrentImageEdit_Sender" || nodeData.name === "Shaobkj_GroupedConcurrentImageEdit" || nodeData.name === "Shaobkj_VIP_APINode_Batch") {
