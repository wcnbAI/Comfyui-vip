...
class Shaobkj_VIP_APINode:
    ...
    def generate_image(self, API密钥, API地址, 模型选择, 使用系统代理, 分辨率, 提示词, 图片比例, 接收模式, 保存格式, 等待时间, seed, **kwargs):
        subject_text = ""
        api_key = API密钥
...
NODE_CLASS_MAPPINGS = {
    "Shaobkj_VIP_APINode": Shaobkj_VIP_APINode,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "Shaobkj_VIP_APINode": "🤖图像生成",
}
